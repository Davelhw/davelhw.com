...
import laughnya from './images/laughnya.png'
...
export const data: ProjectType[] = [
  {
    image: laughnya,
    title: 'Laughnya – Humor & Community Platform',
    link: 'https://laughnya.com',
    description:
    ...
    tech: ['NestJS', 'NextJS', 'TypeScript', 'PostgreSQL', 'Prisma', 'JWT Auth', 'Community System']
  },
  {
    image: securegpt,
    title: 'Secure GPT Gateway (AI Governance Control Plane)/(In Development)',
